        ...
        <div>
            <div className="rounded-xl">
                <div className="grid grid-cols-12 gap-6 mt-[12px]">
                    ...
                    <div className="bg-white col-span-4 py-6 flex justify-center items-center rounded-lg shadow-sm">
                        <div className="flex flex-col justify-center items-center text-center">
                            <svg width="70" height="70" viewBox="0 0 27 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="bg-white col-span-4 py-6 flex justify-center items-center rounded-lg shadow-sm">
                        <div className="flex flex-col justify-center items-center text-center">
                            <svg width="70" height="70" viewBox="0 0 35 25" fill="none" xmlns="http://www.w3.org/2000/svg">
